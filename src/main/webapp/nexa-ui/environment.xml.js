if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("Base", "form", "./Base/", "dynamic", null, "", "0", "0");
        nexacro._addService("FrameBase", "form", "./FrameBase/", "dynamic", null, "", "0", "0");
        nexacro._addService("Form", "form", "./Form/", "dynamic", null, "", "0", "0");
        nexacro._addService("com", "form", "./com/", "dynamic", null, "", "0", "0");
        nexacro._addService("login", "form", "./com/login/", "dynamic", null, "", "0", "0");
        nexacro._addService("Default", "form", "./Default/", "session", null, "", "0", "0");
        nexacro._addService("common", "file", "./common/", "session", null, "", "0", "0");
        nexacro._addService("strURL", "JSP", "http://localhost:8080/edu-egov/", "session", null, "", "0", "0");
